...
2. The validator runs format-specific checks for GeoJSON and CSV.
3. The report model normalizes feature counts, fields, geometry types, bounds, null counts, check results, status, and readiness score.
...
- Add GeoPackage and Shapefile validation through GeoPandas or Pyogrio.
